...
# COPILOT STUFF:
# Language: sqf / sqs / BIS / Python
# Description: Python script that carries out defined tasks over multiple objects in an Arma 3 composition.
# Usage:

# > Edit MACRO_INIT, MACROS and COMMON_GROUPS in your input file.
# > Add your input file name below.
INPUT_FORMAT      = "comp_formatter/formats/composition_format_fob.json"
INPUT_FILE        = "comp_formatter/in/comp_in.txt"
ADD_DESCRITPION   = True
PRE_SPAWN_SCRIPT  = ""
POST_SPAWN_SCRIPT = ""
# > Run the script.
# > Paste the output array from  `BIS_fnc_objectsGrabber` in Arma 3 into the script's active terminal. 
# # https://community.bistudio.com/wiki/BIS_fnc_objectsGrabber
# > Output is a composition array that can be pasted from the output file (composition.json) into -
# # - your SQF code and can be spawned using `BIS_fnc_objectsMapper`. https://community.bistudio.com/wiki/BIS_fnc_objectsMapper
...
with open("comp_formatter/out/composition.json", "w+") as comp:
    dump(OUT, comp, indent=4)
    
with open("comp_formatter/out/composition.sqf", "w+") as comp:    
    comp.write(f"""
// Generated by comp_formatter.py - By A3R0 - github.com/hostinfodev
params["_pos", ["_azimuth", 0], ["_chance", 0]];
{PRE_SPAWN_SCRIPT}
[_pos, _azimuth, {dumps(OUT, indent=4)}, _chance] call BIS_fnc_objectsMapper;
{POST_SPAWN_SCRIPT}
""")
    
with open("comp_formatter/out/composition_variable.sqf", "w+") as comp:    
    comp.write(f"""
// Generated by comp_formatter.py - By A3R0 - github.com/hostinfodev
_composition = [_pos, _azimuth, {dumps(OUT, indent=4)}, _chance];
""")    
